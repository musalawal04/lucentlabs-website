...
export default function ContactSection() {
  ...
  return (
    <div className="relative w-full">
      <Circle
        face="left"
        className="left-0 opacity-30 absolute bg-pink-600 -translate-x-[30%] blur-3xl translate-y-[150%]"
      />
          ...
          <div className="bg-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/10">
            <div className="space-y-4 mb-8">
              <h1 className="text-5xl font-bold">
                ...
                <br />
                Let&apos;s chat!{" "}
                <MessageCircle size={32} className="inline-block ml-2" />
              </h1>
            </div>
            ...
            <div className="mt-12 relative rounded-3xl">
              <div className="animate-spin delay-[5000]  transition ease-in">
                ...
                >
                  <path
                    id="textPath"
                    d="M80,10 a70,70 0 0,1 0,140 a70,70 0 0,1 0,-140"
                    fill="none"
                  />
      ...
      <Circle
        face="right"
        className="-right-[100%] opacity-30 absolute bg-pink-600 -translate-x-[30%] blur-3xl -translate-y-[150%]"
      />
    </div>
  );
}
