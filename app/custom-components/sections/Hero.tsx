    ...
    <Wrapper className='w-full relative min-h-max max-w-full lg:py-10 flex flex-col items-center'>
      <div className='lg:max-w-[80%] w-full min-h-full relative'>
        ...
        <div className='flex flex-col items-center max-md:gap-4 justify-center z-10'>
          <h1 className={`hero-text lg:text-[90px] xl:text-[100px] max-md:mt-20 md:text-[60px] text-[45px] break-words text-center ${kanit.className} font-semibold`}>Web3 Development <br /> <span className='cgradient-text lg:text-[120px]'>Agency.</span></h1>
        ...
        <div className='flex md:flex-row flex-col max-md:items-center gap-6'>
          ...
          <div className='flex relative flex-1 md:w-[60%] w-[90%] justify-center'>
            ...
            <Image src={"/abstract.png"} alt='company' width={300} height={300} className='w-[80%] max-w-[600px] max-h-[600px] relative' />
          ...
          <div className='flex gap-4 flex-col'>
            <div className='md:flex hidden flex-col gap-6 py-4 px-6 backdrop-blur-xl bg-gradient-to-r from-transparent to-white/5 border-none rounded-lg'>
              <div className='flex gap-2 items-center'>
                ...
                <span className='text-white text-[24px] lg:text-[30px]'>2+</span>
              </div>
              <span className='gray-gradient-text uppercase'>Ongoing Collaborations</span>
            </div>
