...
//     id: 6,
//     name: "Dr. Aisha Khan",
//     role: "Blockchain Strategy Advisor",
//     bio: "Expert in blockchain governance and decentralized finance, providing strategic insights for scalable Web3 solutions.",
//     imageUrl: "/El-Raulito.jpg?height=400&width=400",
//     socialLinks: {
//       twitter: "https://twitter.com/aishakhan",
//       linkedin: "https://linkedin.com/in/aishakhan",
//     },
//     skills: ["Blockchain Governance", "DeFi", "Strategic Planning"],
//   },
//   {
//     id: 7,
...
//     imageUrl: "/michael.jpg?height=400&width=400",
//     socialLinks: {
...
//         <h2
//           className={`text-3xl md:text-4xl font-medium cgradient-text inline-block mb-4 ${kanit.className}`}
//         >
//           Meet Our Team
//         </h2>
//         <p className="text-lg text-gray-300 max-w-2xl mx-auto">
//           Passionate builders and innovators working at the intersection of
//           blockchain technology and user experience.
//         </p>
//       </div>
...
//           Industry experts guiding our vision with strategic and technical
//           expertise.
//         </p>
...
//               whileHover={{ y: -10 }}
//             >
//               <Card className="overflow-hidden h-full border border-blue-500 bg-gradient-to-br from-gray-900 to-black shadow-xl hover:shadow-blue-500/20 transition-all duration-300">
//                 <div className="relative">
...
//                   </div>
//                 </div>
//                 <CardContent className="p-6 bg-gradient-to-b from-gray-900 to-black/95">
//                   <p className="text-sm text-gray-200 mb-4">{advisor.bio}</p>
...
//                         key={skill}
//                         variant="outline"
//                         className="bg-gray-900 text-blue-400 border-blue-500/30 hover:bg-gray-800"
//                       >
//                         {skill}
//                       </Badge>
//                     ))}
...
//                       </a>
//                     )}
//                     {advisor.socialLinks.github && (
//                       <a
//                         href={advisor.socialLinks.github}
//                         target="_blank"
//                         rel="noopener noreferrer"
//                         className="text-gray-300 hover:text-blue-400 transition-colors"
//                       >
...
export const teamMembers: TeamMember[] = [
  {
    ...
    role: "Founder",
    bio: "Blockchain enthusiast, Web3 consultant, Backend Developer (Node Javascript) with years of experience in distributed systems and smart contract architecture development.",
    imageUrl: "/lawal-musa.jpg?height=700&width=400",
    socialLinks: {
      twitter: "https://twitter.com/ADA_dolphin04",
      github: "https://github.com/musalawal04",
      linkedin: "https://linkedin.com",
...
export const advisors: TeamMember[] = [
  {
    id: 6,
    name: "Raul Rosa",
    role: "CTO at Fluidtokens, Technical Advisor",
    bio: "Renowned for contributions to notable protocols on Cardano and Bitcoin, expert in dApp architecture, smart contracts security, guiding technical innovation, and providing strategic insights for scalable web3 solutions.",
    imageUrl: "/El-Raulito.jpg?height=700&width=400",
    socialLinks: {
      twitter: "https://twitter.com/ElRaulito_cnft",
      github: "https://github.com/elRaulito",
    },
    skills: [
      "Electrical Engineer",
      "Distributed Systems",
